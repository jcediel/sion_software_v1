...
<form action="<?php echo PROGRAMA.'?doc='.$doc.'&buscar=Consultar&&opcion=67';?>" method="POST" enctype="multipart/form-data" onsubmit="return validar()" role="form" class="form-horizontal">
	...
	<section class="panel-body"> <!--evolucion to-->
			...
			<article class="col-md-4">
				...
				$sql_realizado="SELECT count(id_d_aut_dom) cuantos
							FROM evo_fono_dom
							WHERE id_d_aut_dom=$d_procedimiento and estado_evofono_dom='Realizada'";
