<section class="panel panel-default">
  <section class="panel-body">
    ...
    <article class="col-md-12 text-center">
      <button data-toggle="collapse" class="btn btn-info btn-lg text-center ol-md-12" data-target="#Pacaut">Consulte AQUI los pacientes que tiene autorizados <br><span class="glyphicon glyphicon-arrow-down"></span> </button>
    </article>
  </section>
  <section class="panel-body">
       ...
       <section class="panel-heading"><h1>Anuncios Capacitación</h1></section>
         <section class="panel-body">
           ...
           $sql_ag="SELECT a.id_anuncio,a.servicio,a.tipo_anuncio,a.freg,a.hreg,a.titulo,a.anuncio,a.estado,a.f_elimina,a.resp_elimina ,
                           b.nombre
                         FROM anuncios a inner join user b on a.id_user=b.id_user
                         WHERE a.estado=1 and a.tipo_anuncio=3  and a.grupo_vista in (1,9) ORDER BY a.freg DESC ";
