<?php
  ...
  $eps=$_REQUEST['eps'];
  $sede=$_REQUEST['sede'];
	$consulta = "SELECT IF(a.id_sedes_ips=2,'Faca','Bogota') ciudad,
      c.nom_eps,
	...
	if($resultado->num_rows > 0 ){
		...
		$objPHPExcel->getProperties()->setCreator("Codedrinks") //Autor
							 ...
							 ->setTitle("INFORME CONTROL DOCUMENTAL SM")
							 ->setSubject("INFORME CONTROL DOCUMENTAL SM")
							 ->setDescription("INFORME CONTROL DOCUMENTAL SM")
							 ->setKeywords("INFORME CONTROL DOCUMENTAL SM")
							 ->setCategory("Reporte excel");

		$tituloReporte = "INFORME CONTROL DOCUMENTAL SM";
		$titulosColumnas = array('NOMBRE', 'DOCUMENTO','SEDE', 'EPS','INGRESO','EGRESO', 'DOCUMENTO', 'AUTORIZACION', 'CONSENTIMIENTO', 'EPICRISIS', 'PAGARE');
