<?php
  ...
  $f2=$_REQUEST['f2'];
  $sede=$_REQUEST['sede'];
	$consulta = "SELECT count(a.id_food) cuantos,c.costo_food, b.nombre, b.doc, b.id_user, b.foto, e.nombre_perfil, f.nom_sedes, b.cuenta
             FROM food a
	...
	if($resultado->num_rows > 0 ){
		...
		$objPHPExcel->getProperties()->setCreator("Codedrinks") //Autor
							 ...
							 ->setTitle("INFORME SOLICITUD ALMUERZOS")
							 ->setSubject("INFORME SOLICITUD ALMUERZOS")
							 ->setDescription("INFORME SOLICITUD ALMUERZOS")
							 ->setKeywords("INFORME SOLICITUD ALMUERZOS")
							 ->setCategory("Reporte excel");

		$tituloReporte = "INFORME SOLICITUD ALMUERZOS";
		$titulosColumnas = array('NOMBRE','DOCUMENTO','SEDE', 'CANTIDAD','COSTO');
      ...
      $total=$t*$c;
			$objPHPExcel->setActiveSheetIndex(0)
                ->setCellValue('A'.$i,  utf8_encode($fila['nombre']))
        		    ->setCellValue('B'.$i,  $fila['doc'])
		            ->setCellValue('C'.$i,  $fila['nom_sedes'])
        		    ->setCellValue('D'.$i,  $fila['cuantos'])
		...
		$objPHPExcel->getActiveSheet()->setTitle('consolidadoalmuerzos');
		...
		header('Content-Disposition: attachment;filename="consolidadoalmuerzos.xlsx"');
