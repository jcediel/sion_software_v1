<?php
  ...
  $sql_admision="SELECT a.id_paciente idp,tdoc_pac,a.doc_pac,nom1,nom2,ape1,ape2,edad,fnacimiento,dir_pac,tel_pac,rh,email_pac,genero,fotopac,
        ...
        <section class="collapse" id="datpac">
          <section class="panel-body"><!--section de eps-->
            <article class="col-md-8 text-center">
              <label for="">Nombre Completo (<?php echo $fila_admision['idp'] ?>):</label>
