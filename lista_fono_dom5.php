...
if (isset($_GET["mante"])){					///nivel 2
    ...
    where b.id_adm_hosp ='".$_GET["idadmhosp"]."'" ;
      ...
      where b.id_adm_hosp ='".$_GET["idadmhosp"]."'" ;
			...
			$date1=date('H:i');
			$doc=$_REQUEST['doc'];
			$form1='formulariosDOM/FONO/evo_fono_dom.php';
				...
				foreach ($tabla as $fila) {
					...
					echo'<td class="text-left">
							 ...
							 if ($estado_salida=='Fallecimiento') {
							 	echo '<td><p class="alert alert-danger"><span class="fa fa-skull-crossbones"></span> Paciente Fallecido</p></td>';
							 }
							 if ($estado_salida=='Hospitalizado') {
							 	echo '<td><p class="alert alert-danger"><span class="fa fa-procedures"></span> Paciente Hospitalizado</p></td>';
							 }
							 if ($estado_salida=='') {
