  ...
  <section class="panel-body">
    <section class="col-md-12">
      <article class="col-md-4 text-center ">
        <button type="button" class="btn btn-warning text-center" data-toggle="modal" data-target="#tickets_p1">
          ...
          <div id="tickets_p1" class="modal fade" role="dialog">
      ...
      <article class="col-md-4 text-center">
        <button type="button" class="btn btn-info text-center" data-toggle="modal" data-target="#tickets_r1">
          <span class="fa fa-ticket-alt fa-3x">
          </span> <span class="badge animated shake">
            <?php
            $usuario=$_SESSION['AUT']["id_user"];
          ...
          <div id="tickets_r1" class="modal fade" role="dialog">
            <div class="modal-dialog modal-lg text-left">
              <!-- Modal content de casos pendientes-->
              <div class="modal-content">
                <div class="modal-header">
      ...
      <article class="col-md-4 text-center">
        <button type="button" class="btn btn-success text-center" data-toggle="modal" data-target="#tickets_c1">
          <span class="fa fa-ticket-alt fa-3x">
          </span> <span class="badge animated shake">
            <?php
            $usuario=$_SESSION['AUT']["id_user"];
          ...
          <div id="tickets_c1" class="modal fade" role="dialog">
            <div class="modal-dialog modal-lg text-left">
              <!-- Modal content de casos pendientes-->
              <div class="modal-content">
                <div class="modal-header">
