<section class="panel-body">
  <section class="col-md-12 col-sm-12">
    <article class="col-md-4 text-center ">
      <button type="button" class="btn btn-warning text-center" data-toggle="modal" data-target="#tickets_p">
        <span class="fa fa-ticket-alt fa-3x">
          ...
          $sql_c_p="SELECT count(a.id_hdesk) cuantos
                    ...
                    WHERE estado_soporte=2 and a.id_user=$usuario group by id_hdesk";
                    //echo $sql_c_p;
                        $i=1;
        ...
        <div id="tickets_p" class="modal fade" role="dialog">
          <div class="modal-dialog modal-lg"><!-- Modal content de casos pendientes-->
            <div class="modal-content">
              ...
              <div class="modal-body">
                <?php
                $usuario=$_SESSION['AUT']["id_user"];
                $sql_pendiente="SELECT a.*, b.nombre realiza, c.nombre respon1, d.nombre respon2
                              ...
                              WHERE a.estado_soporte in (2) and a.id_user=$usuario
                              order by freg_hdesk asc";
                              //echo $sql_pendiente;
                              $i=1;
    ...
    </article><!--modal tickets resueltos-->
    <article class="col-md-4 text-center">
      <button type="button" class="btn btn-info text-center" data-toggle="modal" data-target="#tickets_r">
        <span class="fa fa-ticket-alt fa-3x">
        </span> <span class="badge animated shake">
          <?php
          $usuario=$_SESSION['AUT']["id_user"];
          $sql_c_r="SELECT COUNT(a.id_hdesk) cuantos
                    FROM help_desk a inner join user b on a.id_user=b.id_user
                                     inner join aux_user_sedes c on c.id_user=b.id_user
                    WHERE estado_soporte=3 and a.id_user=$usuario ";
                        $i=1;
        ...
        <div id="tickets_r" class="modal fade" role="dialog">
          <div class="modal-dialog modal-lg text-left"><!-- Modal content de casos pendientes-->
            <div class="modal-content">
              <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal">&times;</button>
              ...
              <div class="modal-body">
                <?php
                $usuario=$_SESSION['AUT']["id_user"];
                $sql_resueltos="SELECT a.*, b.nombre realiza, c.nombre respon1, d.nombre respon2
                              FROM help_desk a LEFT JOIN user b on a.id_user=b.id_user
                                               LEFT JOIN user c on c.id_user=a.user_rta1
                                               LEFT JOIN user d on d.id_user=a.user_rta2
                              WHERE a.estado_soporte in (3) and a.id_user=$usuario
                              order by freg_hdesk asc";//echo $sql_pendiente;
                              $i=1;
                      ...
                      echo'<article class="col-md-12 ">';
                          ...
                          echo'</article>';
                           echo'<article class="col-md-12 alert alert-info">
                              ...
                              }// se ve la segunda respuesta
                              echo '<section>
                              <p><a href="'.PROGRAMA.'?opcion='.$_REQUEST["opcion"].'&mante=CERRAR&id='.$fila_resueltos['id_hdesk'].'">
                              <button type="button type="button" class="btn btn-success">
                              <span class="fa fa-edit"></span>Cerrar caso</button></a></p>
                              </section>';
                    echo'</section>';
                  }
                }
    ...
    <article class="col-md-4 text-center">
      <button type="button" class="btn btn-success text-center" data-toggle="modal" data-target="#tickets_c">
        <span class="fa fa-ticket-alt fa-3x">
        </span> <span class="badge animated shake">
          <?php
          $usuario=$_SESSION['AUT']["id_user"];
          $sql_c_c="SELECT COUNT(a.id_hdesk) cuantos
                    FROM help_desk a inner join user b on a.id_user=b.id_user
                                     inner join aux_user_sedes c on c.id_user=b.id_user
                    WHERE estado_soporte=4 and a.id_user=$usuario";
                        //echo $sql_c_r;
                        $i=1;
        ...
        <div id="tickets_c" class="modal fade" role="dialog">
          <div class="modal-dialog modal-lg text-left">
            <!-- Modal content de casos cerrados-->
            <div class="modal-content">
              <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal">&times;</button>
              ...
              <div class="modal-body">
                <?php
                $usuario=$_SESSION['AUT']["id_user"];
                $sql_cerrados="SELECT a.*, b.nombre realiza, c.nombre respon1, d.nombre respon2
                              FROM help_desk a LEFT JOIN user b on a.id_user=b.id_user
                                               LEFT JOIN user c on c.id_user=a.user_rta1
                                               LEFT JOIN user d on d.id_user=a.user_rta2
                              WHERE a.estado_soporte in (4) and a.id_user=$usuario
                              order by freg_hdesk asc";
                              //echo $sql_pendiente;
                              $i=1;
    ...
    <section class="panel-body">
      <table class="table table-striped"><br>
              ...
              <article class="row panel-body text-center">
                <a href="<?php echo PROGRAMA.'?opcion='.$_REQUEST["opcion"].'&mante=ADDHDESK'?>" align="center" ><button type="button" class="btn btn-default" ><strong>Generar Tickets</strong></button></a>
              </article>
            <?php
            $usuario=$_SESSION['AUT']["id_user"];
            $sql_usuario="SELECT a.*, b.nombre realiza, c.nombre respon1, d.nombre respon2
                          FROM help_desk a LEFT JOIN user b on a.id_user=b.id_user
                                           LEFT JOIN user c on c.id_user=a.user_rta1
                                           LEFT JOIN user d on d.id_user=a.user_rta2
                          WHERE a.estado_soporte in (1,2,3) and a.id_user=$usuario
                          order by freg_hdesk asc";
                          $i=1;
                              ...
                              <div class="modal-dialog modal-lg text-left">
                                <div class="modal-content">
                                  <div class="modal-header">
                                   ...
                                   <button type="button" class="btn btn-success align-items-left"><span class="fa fa-file-text"></span> Cargar Evidencia</button></a></p>
                                  </div>
                                  <div class="modal-body">';
                                  $id=$filau['id_hdesk'];
